...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.121/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| cmp1-borderleaf1 | Vlan4094 | 100.64.14.9 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_cmp1-bleaf1b_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_cmp1-bleaf1b_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_CMP1-SPINE1_Ethernet1 | routed | - | 100.64.10.33/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_CMP1-SPINE2_Ethernet1 | routed | - | 100.64.10.35/31 | default | 1500 | false | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-BLEAF1A_Ethernet5 | routed | - | 100.64.10.37/31 | default | 1500 | false | - | - |
| Ethernet6 | P2P_LINK_TO_DC1-BLEAF1B_Ethernet5 | routed | - | 100.64.10.39/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_cmp1-bleaf1b_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_cmp1-bleaf1b_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_LINK_TO_CMP1-SPINE1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_CMP1-SPINE2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.10.35/31
!
interface Ethernet5
   description P2P_LINK_TO_DC1-BLEAF1A_Ethernet5
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.10.37/31
!
interface Ethernet6
   description P2P_LINK_TO_DC1-BLEAF1B_Ethernet5
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.10.39/31
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_cmp1-bleaf1b_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_cmp1-bleaf1b_Po1
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4093 |  default  |  100.64.13.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  100.64.14.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| 100.64.10.34 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.10.36 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.10.38 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| 100.64.13.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description cmp1-bleaf1b
   ...
   neighbor 100.64.10.32 description cmp1-spine1_Ethernet1
   neighbor 100.64.10.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.34 remote-as 65001
   neighbor 100.64.10.34 description cmp1-spine2_Ethernet1
   neighbor 100.64.10.36 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.36 remote-as 65203
   neighbor 100.64.10.36 description dc1-bleaf1a_Ethernet5
   neighbor 100.64.10.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.38 remote-as 65203
   neighbor 100.64.10.38 description dc1-bleaf1b_Ethernet5
   ...
   neighbor 100.64.13.9 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 100.64.13.9 description cmp1-bleaf1b
