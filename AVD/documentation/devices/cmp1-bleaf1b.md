...
| --------- | --------------- | ------------ | --------- |
| cmp1-borderleaf1 | Vlan4094 | 100.64.14.8 | Port-Channel1 |
...
!
mlag configuration
   domain-id cmp1-borderleaf1
   local-interface Vlan4094
   peer-address 100.64.14.8
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_cmp1-bleaf1a_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_cmp1-bleaf1a_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_CMP1-SPINE1_Ethernet2 | routed | - | 100.64.10.41/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_CMP1-SPINE2_Ethernet2 | routed | - | 100.64.10.43/31 | default | 1500 | false | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-BLEAF1A_Ethernet6 | routed | - | 100.64.10.45/31 | default | 1500 | false | - | - |
| Ethernet6 | P2P_LINK_TO_DC1-BLEAF1B_Ethernet6 | routed | - | 100.64.10.47/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_cmp1-bleaf1a_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_cmp1-bleaf1a_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_LINK_TO_CMP1-SPINE1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_CMP1-SPINE2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.10.43/31
!
interface Ethernet5
   description P2P_LINK_TO_DC1-BLEAF1A_Ethernet6
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.10.45/31
!
interface Ethernet6
   description P2P_LINK_TO_DC1-BLEAF1B_Ethernet6
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.10.47/31
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_cmp1-bleaf1a_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_cmp1-bleaf1a_Po1
   no shutdown
   switchport
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.12.15/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4093 |  default  |  100.64.13.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  100.64.14.9/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 100.64.10.40 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.10.42 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.10.44 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.10.46 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| 100.64.13.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description cmp1-bleaf1a
   ...
   neighbor 100.64.10.40 remote-as 65001
   neighbor 100.64.10.40 description cmp1-spine1_Ethernet2
   neighbor 100.64.10.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.42 remote-as 65001
   neighbor 100.64.10.42 description cmp1-spine2_Ethernet2
   neighbor 100.64.10.44 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.44 remote-as 65203
   neighbor 100.64.10.44 description dc1-bleaf1a_Ethernet6
   neighbor 100.64.10.46 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.46 remote-as 65203
   neighbor 100.64.10.46 description dc1-bleaf1b_Ethernet6
   ...
   neighbor 100.64.13.8 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 100.64.13.8 description cmp1-bleaf1a
