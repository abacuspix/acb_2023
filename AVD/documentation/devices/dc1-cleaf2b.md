...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.116/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| dc1-cleaf2 | Vlan4094 | 100.64.24.4 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_dc1-cleaf2a_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_dc1-cleaf2a_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE1_Ethernet6 | routed | - | 100.64.20.25/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE2_Ethernet6 | routed | - | 100.64.20.27/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_dc1-cleaf2a_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_dc1-cleaf2a_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_dc1-cleaf2a_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_dc1-cleaf2a_Po1
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.64.21.14/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.22.13/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4093 |  default  |  100.64.23.5/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  100.64.24.5/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 100.64.20.24 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.20.26 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| 100.64.23.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
router bgp 65202
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-cleaf2a
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 $1c$U4tL2vQP9QwZlxIV1K3/pw==
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 100.64.20.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.20.24 remote-as 65002
   neighbor 100.64.20.24 description dc1-spine1_Ethernet6
   neighbor 100.64.20.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.20.26 remote-as 65002
   neighbor 100.64.20.26 description dc1-spine2_Ethernet6
   ...
   neighbor 100.64.23.4 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 100.64.23.4 description dc1-cleaf2a
