...
| --------- | --------------- | ------------ | --------- |
| cmp1-leaf1 | Vlan4094 | 100.64.14.1 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_cmp1-leaf1b_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_cmp1-leaf1b_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet5 | CMP1-L2LEAF1A_Ethernet3 | *trunk | *none | *- | *- | 5 |
| Ethernet6 | CMP1-L2LEAF1B_Ethernet3 | *trunk | *none | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_CMP1-SPINE1_Ethernet3 | routed | - | 100.64.10.1/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_CMP1-SPINE2_Ethernet3 | routed | - | 100.64.10.3/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_cmp1-leaf1b_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_cmp1-leaf1b_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_LINK_TO_CMP1-SPINE1_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_CMP1-SPINE2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description CMP1-L2LEAF1A_Ethernet3
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description CMP1-L2LEAF1B_Ethernet3
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_cmp1-leaf1b_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel5 | CMP1-L2LEAF1_Po3 | switched | trunk | none | - | - | - | - | 5 | - |
...
interface Port-Channel1
   description MLAG_PEER_cmp1-leaf1b_Po1
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.64.11.11/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 100.64.10.0 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.10.2 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| 100.64.13.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description cmp1-leaf1b
   ...
   neighbor 100.64.10.0 remote-as 65001
   neighbor 100.64.10.0 description cmp1-spine1_Ethernet3
   neighbor 100.64.10.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.2 remote-as 65001
   neighbor 100.64.10.2 description cmp1-spine2_Ethernet3
   ...
   neighbor 100.64.13.1 description cmp1-leaf1b
