...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.126/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| cmp1-leaf2 | Vlan4094 | 100.64.14.4 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_cmp1-leaf2a_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_cmp1-leaf2a_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_CMP1-SPINE1_Ethernet6 | routed | - | 100.64.10.25/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_CMP1-SPINE2_Ethernet6 | routed | - | 100.64.10.27/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_cmp1-leaf2a_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_cmp1-leaf2a_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_LINK_TO_CMP1-SPINE1_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_CMP1-SPINE2_Ethernet6
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.10.27/31
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_cmp1-leaf2a_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_cmp1-leaf2a_Po1
   no shutdown
   switchport
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.12.13/32 |
...
| 100.64.10.26 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| 100.64.13.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description cmp1-leaf2a
   ...
   neighbor 100.64.10.24 description cmp1-spine1_Ethernet6
   neighbor 100.64.10.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.26 remote-as 65001
   neighbor 100.64.10.26 description cmp1-spine2_Ethernet6
   ...
   neighbor 100.64.13.4 description cmp1-leaf2a
