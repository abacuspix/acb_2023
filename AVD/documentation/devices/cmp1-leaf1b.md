...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.124/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| cmp1-leaf1 | Vlan4094 | 100.64.14.0 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_cmp1-leaf1a_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_cmp1-leaf1a_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet5 | CMP1-L2LEAF1A_Ethernet4 | *trunk | *none | *- | *- | 5 |
| Ethernet6 | CMP1-L2LEAF1B_Ethernet4 | *trunk | *none | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_CMP1-SPINE1_Ethernet4 | routed | - | 100.64.10.9/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_CMP1-SPINE2_Ethernet4 | routed | - | 100.64.10.11/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_cmp1-leaf1a_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_cmp1-leaf1a_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_LINK_TO_CMP1-SPINE1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_CMP1-SPINE2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.10.11/31
!
interface Ethernet5
   description CMP1-L2LEAF1A_Ethernet4
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description CMP1-L2LEAF1B_Ethernet4
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_cmp1-leaf1a_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_cmp1-leaf1a_Po1
   no shutdown
   switchport
...
| 100.64.10.10 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description cmp1-leaf1a
   ...
   neighbor 100.64.10.8 description cmp1-spine1_Ethernet4
   neighbor 100.64.10.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.10 remote-as 65001
   neighbor 100.64.10.10 description cmp1-spine2_Ethernet4
   ...
   neighbor 100.64.13.0 description cmp1-leaf1a
