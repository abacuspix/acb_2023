...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.112/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| dc1-bleaf1 | Vlan4094 | 100.64.24.8 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_dc1-bleaf1a_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_dc1-bleaf1a_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE1_Ethernet2 | routed | - | 100.64.20.41/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE2_Ethernet2 | routed | - | 100.64.20.43/31 | default | 1500 | false | - | - |
| Ethernet5 | P2P_LINK_TO_CMP1-BLEAF1A_Ethernet6 | routed | - | 100.64.10.38/31 | default | 1500 | false | - | - |
| Ethernet6 | P2P_LINK_TO_CMP1-BLEAF1B_Ethernet6 | routed | - | 100.64.10.46/31 | default | 1500 | false | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_dc1-bleaf1a_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.64.21.16/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.22.15/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4093 |  default  |  100.64.23.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  100.64.24.9/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 100.64.10.39 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.10.47 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.20.40 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 100.64.20.42 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| 100.64.23.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
router bgp 65203
   ...
   neighbor 100.64.10.39 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.39 remote-as 65103
   neighbor 100.64.10.39 description cmp1-bleaf1a_Ethernet6
   neighbor 100.64.10.47 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.47 remote-as 65103
   neighbor 100.64.10.47 description cmp1-bleaf1b_Ethernet6
   neighbor 100.64.20.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.20.40 remote-as 65002
   neighbor 100.64.20.40 description dc1-spine1_Ethernet2
   neighbor 100.64.20.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.20.42 remote-as 65002
   neighbor 100.64.20.42 description dc1-spine2_Ethernet2
   ...
   neighbor 100.64.23.8 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 100.64.23.8 description dc1-bleaf1a
