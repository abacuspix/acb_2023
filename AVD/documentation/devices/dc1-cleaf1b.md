...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.114/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| dc1-cleaf1 | Vlan4094 | 100.64.24.0 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_dc1-cleaf1a_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_dc1-cleaf1a_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE1_Ethernet4 | routed | - | 100.64.20.9/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE2_Ethernet4 | routed | - | 100.64.20.11/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_dc1-cleaf1a_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_dc1-cleaf1a_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_dc1-cleaf1a_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_dc1-cleaf1a_Po1
   no shutdown
   switchport
...
| 100.64.20.10 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
router bgp 65201
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-cleaf1a
   ...
   neighbor 100.64.20.8 description dc1-spine1_Ethernet4
   neighbor 100.64.20.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.20.10 remote-as 65002
   neighbor 100.64.20.10 description dc1-spine2_Ethernet4
   ...
   neighbor 100.64.23.0 description dc1-cleaf1a
