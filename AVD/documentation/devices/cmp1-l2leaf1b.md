...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.128/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| cmp1-l2leaf1 | Vlan4094 | 100.64.15.0 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_cmp1-l2leaf1a_Ethernet1 | *trunk | *2-4094 | *- | *['MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_cmp1-l2leaf1a_Ethernet2 | *trunk | *2-4094 | *- | *['MLAG'] | 1 |
| Ethernet3 | CMP1-LEAF1A_Ethernet6 | *trunk | *none | *- | *- | 3 |
| Ethernet4 | CMP1-LEAF1B_Ethernet6 | *trunk | *none | *- | *- | 3 |
...
!
interface Ethernet1
   description MLAG_PEER_cmp1-l2leaf1a_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_cmp1-l2leaf1a_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description CMP1-LEAF1A_Ethernet6
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description CMP1-LEAF1B_Ethernet6
   no shutdown
   channel-group 3 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_cmp1-l2leaf1a_Po1 | switched | trunk | 2-4094 | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_cmp1-l2leaf1a_Po1
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4094 |  default  |  100.64.15.1/31  |  -  |  -  |  -  |  -  |  -  |
