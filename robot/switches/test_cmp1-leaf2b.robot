...
Ping Test 1 - VRF DEV - cmp1-bleaf1a
    ...
    Write              ping vrf DEV 172.16.11.15 source 172.16.11.14 repeat 3
...
Ping Test 2 - VRF DEV - cmp1-bleaf1b
    ...
    Write              ping vrf DEV 172.16.11.16 source 172.16.11.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 3 - VRF DEV - cmp1-leaf1a
    ...
    Write              ping vrf DEV 172.16.11.11 source 172.16.11.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 4 - VRF DEV - cmp1-leaf1b
    ...
    Write              ping vrf DEV 172.16.11.12 source 172.16.11.14 repeat 3
    ${output}=         Read                   delay=0.5s
    Should Contain     ${output}              80 bytes from 172.16.11.12

Ping Test 5 - VRF DEV - cmp1-leaf2a
    [Documentation]    Test connectivity in VRF DEV towards cmp1-leaf2a
    Write              ping vrf DEV 172.16.11.13 source 172.16.11.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 6 - VRF HR - cmp1-bleaf1a
    ...
    Write              ping vrf HR 172.16.12.15 source 172.16.12.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 7 - VRF HR - cmp1-bleaf1b
    ...
    Write              ping vrf HR 172.16.12.16 source 172.16.12.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 8 - VRF HR - cmp1-leaf1a
    ...
    Write              ping vrf HR 172.16.12.11 source 172.16.12.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 9 - VRF HR - cmp1-leaf1b
    ...
    Write              ping vrf HR 172.16.12.12 source 172.16.12.14 repeat 3
    ${output}=         Read                   delay=0.5s
    Should Contain     ${output}              80 bytes from 172.16.12.12

Ping Test 10 - VRF HR - cmp1-leaf2a
    [Documentation]    Test connectivity in VRF HR towards cmp1-leaf2a
    Write              ping vrf HR 172.16.12.13 source 172.16.12.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 11 - VRF FINANCE - cmp1-bleaf1a
    ...
    Write              ping vrf FINANCE 172.16.13.15 source 172.16.13.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 12 - VRF FINANCE - cmp1-bleaf1b
    ...
    Write              ping vrf FINANCE 172.16.13.16 source 172.16.13.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 13 - VRF FINANCE - cmp1-leaf1a
    ...
    Write              ping vrf FINANCE 172.16.13.11 source 172.16.13.14 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 14 - VRF FINANCE - cmp1-leaf1b
    ...
    Write              ping vrf FINANCE 172.16.13.12 source 172.16.13.14 repeat 3
    ${output}=         Read                   delay=0.5s
    Should Contain     ${output}              80 bytes from 172.16.13.12

Ping Test 15 - VRF FINANCE - cmp1-leaf2a
    [Documentation]    Test connectivity in VRF FINANCE towards cmp1-leaf2a
    Write              ping vrf FINANCE 172.16.13.13 source 172.16.13.14 repeat 3
    ${output}=         Read                   delay=0.5s
