...
Ping Test 1 - VRF SERVERS - dc1-bleaf1a
    ...
    Write              ping vrf SERVERS 172.17.10.15 source 172.17.10.12 repeat 3
...
Ping Test 2 - VRF SERVERS - dc1-bleaf1b
    ...
    Write              ping vrf SERVERS 172.17.10.16 source 172.17.10.12 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 3 - VRF SERVERS - dc1-cleaf1a
    ...
    Write              ping vrf SERVERS 172.17.10.11 source 172.17.10.12 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 4 - VRF SERVERS - dc1-cleaf2a
    ...
    Write              ping vrf SERVERS 172.17.10.13 source 172.17.10.12 repeat 3
    ${output}=         Read                   delay=0.5s
...
Ping Test 5 - VRF SERVERS - dc1-cleaf2b
    ...
    Write              ping vrf SERVERS 172.17.10.14 source 172.17.10.12 repeat 3
    ${output}=         Read                   delay=0.5s
